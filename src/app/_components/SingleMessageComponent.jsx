...
const SingleMessageComponent = ({ content, isUserMessage }) => {
  return (
    <div className={cn({
        ...
        <div className="p-6">
            ...
            <div className="max-w-3xl mx-auto flex items-start gap-2 5">
                ...
                <div 
                    className={cn("size-10 shrink-0 aspect-square rounded-full border border-zinc-700 bg-zinc-900 flex justify-center items-center", {
                ...
                <div className="flex flex-col ml-6 w-full">
                    ...
                    <div className="flex items-center-space-x-2">
                        ...
                        <span className="text-sm font-semibold text-white">{isUserMessage ? 'You' : 'Bot' }</span>
